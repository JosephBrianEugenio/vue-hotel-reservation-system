...
<template>
  <div class="row q-ma-xl q-gutter-y-xl">
    ...
    <div class="col-12 col-xs-12 col-md-5 col-lg-5 text-center">
      <q-img src="Static/Villa/villa1.jpg" class="image-attractions" />
    </div>
    ...
    <div class="col-12 col-xs-12 col-md-5 col-lg-5 text-center">
      <q-img src="Static/Villa/villa2.jpg" class="image-attractions" />
    </div>

    <div class="col-12 col-xs-12 col-md-5 col-lg-5 text-center">
      <q-img src="Static/Villa/villa3.jpg" class="image-attractions" />
    </div>
